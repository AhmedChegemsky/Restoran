...
const datalist = [
  {
    imgSrc: "./assets/imgs/dishes/1.png",
    name: 'Гамбургер 1',
    price: 200,
  },
  {
    imgSrc: "./assets/imgs/dishes/2.png",
    name: 'Гамбургер 123',
    price: 250,
  },
  {
    imgSrc: "./assets/imgs/dishes/3.png",
    name: 'Гамбургер 3',
    price: 300,
  },
...
function checkActiveItem(){
  let items = Array.from(list.children); //находим эл. превращаем в массив
